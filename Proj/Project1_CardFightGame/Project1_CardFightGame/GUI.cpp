...
void GUI::drawStats()
{
	...
	for (int i = 1; i < 4; i++)
	{
		...
		if (i == 1)
		{
			cout << GameManager::getInstance()->getPlayer()->getCharacter()->getName()
				<< "           "
				<< GameManager::getInstance()->getEnemy()->getCharacter()->getName();
		}
		if (i == 2)
		{
			cout << "Health: " << GameManager::getInstance()->getPlayer()->getCharacter()->getHealth()
				<< "            "
				<< "Health: " << GameManager::getInstance()->getEnemy()->getCharacter()->getHealth();
		}
		if (i == 3)
		{
			cout << "Energy: " << GameManager::getInstance()->getPlayer()->getCharacter()->getEnergy()
				<< "            "
				<< "Energy: " << GameManager::getInstance()->getEnemy()->getCharacter()->getEnergy();
		}
		cout << "       ";
		cout << char(186) << endl;
	}
...
void GUI::drawChosenCards()
{
	...
	for (int line = 0; line <= 12; line++)
	{
		...
		if (line == 5 || line == 6)
		{
			...
			if (line == 5)
			{
				if (GameManager::getInstance()->getPlayer()->getChosenCard()->isItemCard())
					output += " Item";
				else
			...
			{
				if (GameManager::getInstance()->getEnemy()->getChosenCard()->isItemCard())
					output += " Item";
				else
					output += " A: " + to_string(GameManager::getInstance()->
